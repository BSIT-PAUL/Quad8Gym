        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img src="frontend/img/TT.png" alt="">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="main-header header-sticky">
                <div class="container-fluid">
                    <div class="menu-wrapper d-flex align-items-center justify-content-between">
                        <!-- Logo -->
                        <div class="logo">
                            <a href="index.php"><img src="frontend/img/TT.png" alt=""></a>
                        </div>
                        <!-- Main-menu -->
                    ...
                    <div class="row">
                        <div class="col-xl-9 col-lg-9 col-md-10">
                            <div class="hero__caption">
                                <span data-animation="fadeInLeft" data-delay="0.1s">BELIEVE, ACHIEVE, CONQUER</span>
                                <h1 data-animation="fadeInLeft" data-delay="0.4s">QUAD8 GYM</h1>
                                <a href="frontend/courses.php" class="border-btn hero-btn" data-animation="fadeInLeft" data-delay="0.8s">My Courses</a>
                            </div>
                        </div>
                    </div>
                </div>          
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6">
                    <div class="single-topic text-center mb-30">
                        <div class="topic-img">
                            <img src="frontend/assets/img/gallery/cat1.png" alt="">
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="single-topic text-center mb-30">
                        <div class="topic-img">
                            <img src="frontend/assets/img/gallery/cat2.png" alt="">
                            <div class="topic-content-box">
                                <div class="topic-content">
                                    <h3>Group traning</h3>
    ...
    <div class="gallery-area section-padding30 ">
        <div class="container-fluid ">
            <div class="row">
                    ...
                    <div class="box snake mb-30">
                        ...
                        <div class="overlay">
                            <div class="overlay-content">
                                ...
                                <a href="frontend/gallery.php"><i class="ti-plus"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                    <div class="box snake mb-30">
                        <div class="gallery-img big-img" style="background-image: url(frontend/assets/img/gallery/gallery3.png);"></div>
                        <div class="overlay">
                            <div class="overlay-content">
                                <h3>Muscle gaining </h3>
                                <a href="frontend/gallery.php"><i class="ti-plus"></i></a>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                    <div class="box snake mb-30">
                        <div class="gallery-img big-img" style="background-image: url(frontend/assets/img/gallery/gallery4.png);"></div>
                        <div class="overlay">
                            <div class="overlay-content">
                                <h3>Muscle gaining </h3>
                                <a href="frontend/gallery.php"><i class="ti-plus"></i></a>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                    <div class="box snake mb-30">
                        <div class="gallery-img big-img" style="background-image: url(frontend/assets/img/gallery/gallery5.png);"></div>
                        <div class="overlay">
                            <div class="overlay-content">
                                <h3>Muscle gaining </h3>
                                <a href="frontend/gallery.php"><i class="ti-plus"></i></a>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                    <div class="box snake mb-30">
                        <div class="gallery-img big-img" style="background-image: url(frontend/assets/img/gallery/gallery6.png);"></div>
                        <div class="overlay">
                            <div class="overlay-content">
                                <h3>Muscle gaining </h3>
                                <a href="frontend/gallery.php"><i class="ti-plus"></i></a>
                    ...
                    <div class="properties mb-30 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">
                        <div class="properties__card">
                            <div class="about-icon">
                                <img src="frontend/assets/img/icon/price.svg" alt="">
                            </div>
                            <div class="properties__caption">
                                ...
                                <div class="single-features">
                                    <div class="features-icon">
                                        <img src="frontend/assets/img/icon/check.png" alt="">
                                    </div>
                    ...
                    <div class="col-xl-12">
                        <div class="single-footer-caption mb-50 text-center">
                            ...
                            <div class="footer-social mt-30 wow fadeInUp" data-wow-duration="3s" data-wow-delay=".8s">
                                ...
                                <a href="https://www.facebook.com/p/QUAD8-GYM-100086424797671/"><i class="fab fa-facebook-f"></i></a>
